...
2. Math (skills/qector-math-foundations, M0-M8): every delivered decode must assert
   ...
   Run `python scripts/run_manual_math_validation.py` for the public finite proof
   obligations before issuing a green verdict; finite tests do not replace the
   universal proofs in the reference manual.
